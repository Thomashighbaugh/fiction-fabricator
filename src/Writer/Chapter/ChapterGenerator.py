...
def GenerateChapter(
    ...
    if Writer.Config.SCENE_GENERATION_PIPELINE:
        ...
        chapter_context.set_stage1_plot(plot_text)
        ...
        char_dev_text = execute_generation_stage(
            ...
            {
                "ThisChapterOutline": chapter_specific_outline,
                "Stage1Chapter": plot_text,
                "Feedback": ""
            },
            _ChapterNum, _TotalChapters,
            selected_model,
        ...
        chapter_context.set_stage2_char_dev(char_dev_text)
        ...
        chapter_context.set_stage3_dialogue(dialogue_text)

        # STAGE 4: Descriptive Imagery
        final_chapter_text = execute_generation_stage(
            Interface, _Logger, "Descriptive Imagery",
            Writer.Prompts.CHAPTER_GENERATION_STAGE4,
            {
                "ThisChapterOutline": chapter_specific_outline,
                "Stage1Chapter": plot_text,
                "Stage2Chapter": char_dev_text,
                "Stage3Chapter": dialogue_text,
                "Feedback": ""
            },
            _ChapterNum, _TotalChapters,
            selected_model,
        ...
        initial_chapter_draft = final_chapter_text
