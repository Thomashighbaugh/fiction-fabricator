...
class ChapterContext:
    ...
    def __init__(self, chapter_number: int, initial_outline: str):
        ...
        # Add attributes for multi-stage generation
        self.stage1_plot: Optional[str] = None
        self.stage2_char_dev: Optional[str] = None
        self.stage3_dialogue: Optional[str] = None
        self.stage4_descriptive_imagery: Optional[str] = None
    ...
    def set_stage1_plot(self, content: str):
        self.stage1_plot = content

    def set_stage2_char_dev(self, content: str):
        self.stage2_char_dev = content

    def set_stage3_dialogue(self, content: str):
        self.stage3_dialogue = content

    def set_stage4_descriptive_imagery(self, content: str):
        self.stage4_descriptive_imagery = content
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "stage1_plot": self.stage1_plot,
            "stage2_char_dev": self.stage2_char_dev,
            "stage3_dialogue": self.stage3_dialogue,
            "stage4_descriptive_imagery": self.stage4_descriptive_imagery,
        }
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'ChapterContext':
        ...
        # Add for multi-stage generation
        chapter.stage1_plot = data.get("stage1_plot")
        chapter.stage2_char_dev = data.get("stage2_char_dev")
        chapter.stage3_dialogue = data.get("stage3_dialogue")
        chapter.stage4_descriptive_imagery = data.get("stage4_descriptive_imagery")
        return chapter
