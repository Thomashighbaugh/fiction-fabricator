...
"""
    ...
    def run_editing_loop(self) -> None:
        ...
        edit_options = {
            ...
            "6": ("Manage Lorebooks", self._manage_lorebooks_menu),
...
"""
    ...
    def _manage_lorebooks_menu(self) -> None:
    ...
    def _delete_lorebook(self) -> None:
        ...
        if Confirm.ask(
            f"[red]Are you sure you want to delete '{selected_lorebook.name}'?[/red]", default=False
        ):
