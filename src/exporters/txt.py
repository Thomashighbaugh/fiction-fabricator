...
def export_single_txt(book_root: ET.Element, output_path: Path, console: Console) -> None:
    ...
    try:
        ...
        console.print(
            f"[green]Successfully exported TXT file to:[/green] [cyan]{output_path.resolve()}[/cyan]"
        )
...
def export_txt_per_chapter(
    ...
    try:
        ...
        console.print(
            f"[bold red]An unexpected error occurred during per-chapter TXT export: {e}[/bold red]"
        )
