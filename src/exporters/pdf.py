...
def export_pdf(
    ...
    try:
        ...
        base_title_fontname = (
            custom_font_name
            if custom_font_name and custom_font_name in ["Helvetica", "Times-Roman", "Courier"]
            else "Helvetica-Bold"
        )
        base_heading_fontname = (
            custom_font_name
            if custom_font_name and custom_font_name in ["Helvetica", "Times-Roman", "Courier"]
            else "Helvetica-Bold"
        )
        ...
        frontmatter_style = ParagraphStyle(
            "Frontmatter", parent=styles["Normal"], fontSize=11, spaceAfter=12, alignment=TA_CENTER
        )
        ...
        console.print(
            f"[green]Successfully exported PDF file to:[/green] [cyan]{output_path.resolve()}[/cyan]"
        )
