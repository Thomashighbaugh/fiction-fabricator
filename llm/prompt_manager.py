...
class PromptManager:
    ...
    def create_scene_part_generation_prompt(self):
        return create_scene_part_generation_prompt() # ADDED

    def create_scene_part_critique_prompt(self):
        return create_scene_part_critique_prompt() # ADDED

    def create_scene_part_rewrite_prompt(self):
        return create_scene_part_rewrite_prompt() # ADDED

    def create_scene_part_structure_check_prompt(self):
        return create_scene_part_structure_check_prompt() # ADDED

    def create_scene_part_structure_fix_prompt(self):
        return create_scene_part_structure_fix_prompt() # ADDED

    def create_scene_part_enhancement_prompt(self): # Added
        return create_scene_part_enhancement_prompt() # ADDED