...
JSON_FORMAT_INSTRUCTIONS = """Critically important: Your ENTIRE response MUST be valid JSON. Adhere strictly to this format, ensuring correct data types and escaping.
Output ONLY valid JSON, nothing else. No markdown code blocks, no explanations, no extra text after the JSON object."""

JSON_FORMAT_INSTRUCTIONS_BOOKS_SPEC = """Critically important: Your ENTIRE response MUST be valid JSON. Adhere strictly to this format, ensuring correct data types and escaping. Output ONLY valid JSON, nothing else. No markdown code blocks, no explanations, no extra text after the JSON object.
